...
public class Main {
    ...
    public static boolean textArea_1() {
       ...
       if(uid == "0") {
    	   JOptionPane.showMessageDialog(null, "Please Edit the settings and put in your servers UUID from the website! The server can not start until the correct UUID is added!");
    	   return false;
       }else {
    	   getCryptKey();
    	   server.start();
